...
vimsnip.add("forr", "for (${1:size_t} ${2:i} = ${3:length} - 1; $2 >= ${4:0}; $2--) {\n\t$0\n}")

-- Code snippet for range-based for loop (c++11) statement
vimsnip.add("foreach", "for(${1:auto} ${2:var} : ${3:collection_to_loop}) {\n\t$0\n}")

-- Code snippet for enum
vimsnip.add("enum", "enum ${1:MyEnum} {\n\t$0\n};")

-- Code snippet for enum class (c++11)
vimsnip.add("enum class", "enum class ${1:MyClass} {$0};")
...
vimsnip.add("eclass", "class ${1:MyClass} {\npublic:\n\t$2\nprivate:\n\t$3\n};\n")
...
vimsnip.add("interface", "__interface I${1:Interface} {\n\t$0\n};")

-- namespace
vimsnip.add("namespace", "namespace ${1:MyNamespace} {\n\t$0\n}")

-- Code snippet for #ifdef
vimsnip.add("#ifdef", "#ifdef ${1:DEBUG}\n$0\n#endif // $1")

-- Code snippet for #ifndef
vimsnip.add("#ifndef", "#ifndef ${1:DEBUG}\n$0\n#endif // !$1")

-- Code snippet for #if
vimsnip.add("#if", "#if ${1:0}\n$0\n#endif // $1")

-- Code snippet for struct
vimsnip.add("struct", "struct ${1:MyStruct} {\n\t$0\n};")

-- Code snippet for switch statement
vimsnip.add("switch", "switch (${1:switch_on}) {\n\tdefault:\n\t\t$0\n\t\tbreak;\n}")

-- Code snippet for try catch
vimsnip.add("try", "try {\n\t$2\n}\ncatch (${1:const std::exception&}) {\n}")

-- Code snippet for union
vimsnip.add("union", "union ${1:MyUnion} {\n\t$0\n};")

-- Code snippet for printing to std::cout, provided the header is set
vimsnip.add("cout", "std::cout << ${1:message};")

-- Code snippet for std::cin, provided the header is set
vimsnip.add("cin", "std::cin >> $1;")

-- Generic printf() snippet
vimsnip.add("printf", 'printf("$1\\n"$0);')

-- Generic sprintf() snippet
vimsnip.add("sprintf", 'sprintf($1, "$2\\n"$0);')

-- Generic fprintf() snippet
vimsnip.add("fprintf", 'fprintf(${1:stderr}, "$2\\n"$0);')

-- Generic scanf() snippet
vimsnip.add("scanf", 'scanf("$1"$0);')

-- Generic sscanf() snippet
vimsnip.add("sscanf", 'sscanf($1, "$2"$0);')

-- Generic fscanf() snippet
vimsnip.add("fscanf", 'fscanf($1, "$2"$0);')

-- Code snippet for #include " "
vimsnip.add("#inc", '#include "$1"$2')

-- Code snippet for #include < >
vimsnip.add("#inc<", "#include <$1>$2")

-- Code snippet for #define " "
vimsnip.add("def", "#define $0")
...
vimsnip.add("sca", "static_cast<${1:unsigned}>(${2:expr})$3")

-- dynamic_cast<type>(expression)
vimsnip.add("dca", "dynamic_cast<${1:unsigned}>(${2:expr})$3")

-- reinterpret_cast<type>(expression)
vimsnip.add("rca", "reinterpret_cast<${1:unsigned}>(${2:expr})$3")

-- const_cast<type>(expression)
vimsnip.add("cca", "const_cast<${1:unsigned}>(${2:expr})$3")

-- auto function and trailing return
vimsnip.add("af", "auto ${1:name}( ${2:void} ) -> ${3:auto} {\n\t${5}\n}")
...
vimsnip.add("@throws", "@throws ${1:ExceptionName} ${2:Description.}$0")

-- Indicates the exceptions that can be thrown by a function. This tag is a synonym of @throws.
vimsnip.add("@exception", "@exception ${1:ExceptionName} ${2:Description.}$0")
